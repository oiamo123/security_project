...
import { D as DEFAULT_404_COMPONENT } from './astro/server_sX8U_SJJ.mjs';
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { PORT: "8000", OS: process.env.OS, _: process.env._ })?.PROD) {
